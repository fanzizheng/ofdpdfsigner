#ifndef CUSTOM_SIGNSTAMP_RIDING_DIALOG_H
#define CUSTOM_SIGNSTAMP_RIDING_DIALOG_H
...
class Custom_SignStamp_Riding_Dialog : public QDialog
{
    Q_OBJECT
public:
    explicit Custom_SignStamp_Riding_Dialog(QWidget *parent = nullptr, Qt::WindowFlags f = Qt::WindowFlags());
    ~Custom_SignStamp_Riding_Dialog();
...
private:
    ...
    QComboBox * m_RigingStamp;
    int m_doctype;
};

#endif // CUSTOM_SIGNSTAMP_RIDING_DIALOG_H
