...
fz_display_list *pdf_signature_appearance_signed_ext(fz_context *ctx, fz_rect rect, fz_text_language lang, fz_image *img,float alpha,fz_image *showgraphic, const char *left_text, const char *right_text, int include_logo,fz_page *page,drawStampOverTextFunc drawStampOverText,drawStampOverText_EndFunc drawStampOverText_End);
//fzz add end
/*
