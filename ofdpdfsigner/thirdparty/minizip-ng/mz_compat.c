...
//fzz add begin 2022-11-25
unzFile unzOpen2_my(const char* path, zlib_filefunc_def* pzlib_filefunc_def, const void* zipdata, int32_t zipdatalenght)
{
    unzFile unz = NULL;
    void* stream = NULL;
    ...
    void* tempzipdata = (void*)zipdata;
    if (stream != NULL) {

        mz_stream_mem_set_buffer(stream, tempzipdata, zipdatalenght);
    }
    else {
        return NULL;
    }
