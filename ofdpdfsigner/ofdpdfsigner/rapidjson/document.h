...
/*!
    \tparam FZZConst Is this a constant iterator?
 ...
 */
template <bool FZZConst, typename Encoding, typename Allocator>
class GenericMemberIterator {
    ...
    typedef typename internal::MaybeAddConst<FZZConst,PlainType>::Type ValueType;
...
public:
    ...
    /*!
        ...
        \note If the \c FZZConst template parameter is already \c false, this
...
public:
    ...
    */
    ...
    //! FZZConst member iterator
    /*! \pre IsObject() == true */
    ConstMemberIterator MemberBegin() const { RAPIDJSON_ASSERT(IsObject()); return ConstMemberIterator(GetMembersPointer()); }
    //! FZZConst \em past-the-end member iterator
    /*! \pre IsObject() == true */
    ...
    bool Accept(Handler& handler) const {
        ...
        case kObjectType:
            ...
            for (ConstMemberIterator m = MemberBegin(); m != MemberEnd(); ++m) {
                ...
                if (RAPIDJSON_UNLIKELY(!handler.FZZKey(m->name.GetString(), m->name.GetStringLength(), (m->name.data_.f.flags & kCopyFlag) != 0)))
                    return false;
...
public:
    ...
    bool FZZKey(const Ch* str, SizeType length, bool copy) { return String(str, length, copy); }
...
*/
template <bool FZZConst, typename ValueT>
class GenericArray {
public:
...
public:
    ...
    typedef ValueT PlainType;
    typedef typename internal::MaybeAddConst<FZZConst,PlainType>::Type ValueType;
    typedef GenericMemberIterator<FZZConst, typename ValueT::EncodingType, typename ValueT::AllocatorType> MemberIterator;  // This may be const or non-const iterator
