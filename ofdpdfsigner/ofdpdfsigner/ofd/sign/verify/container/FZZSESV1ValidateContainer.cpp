...
#include "ofd/sign/verify/container/FZZSESV1ValidateContainer.h"
...
//-----------------------------------------------------------------------------------------------------------------
FZZSESV1ValidateContainer::FZZSESV1ValidateContainer() : FZZSignedDataValidateContainer()
{
    //DLOG("FZZSESV1ValidateContainer()");
    FZZConst::addClassCount("FZZSESV1ValidateContainer");
...
//-----------------------------------------------------------------------------------------------------------------
FZZSESV1ValidateContainer::~FZZSESV1ValidateContainer()
{
...
//-201 :  load cert error;
int FZZSESV1ValidateContainer::validate(FZZOFDSigType::TYPE type, string signAlgName, CallBack_Verify verifyFunc,const void * callBack_Param, FZZBytes& tbsContent, FZZBytes& signedValue,string & signDN)
{
    ...
    FZZSES_Signature_V1 sesSignature(signedValue);
    ...
    FZZBytes certDER = toSign->getCert();
