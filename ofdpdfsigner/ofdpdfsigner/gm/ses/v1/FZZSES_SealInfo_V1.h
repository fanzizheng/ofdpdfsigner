...
//
#ifndef FZZSES_SEALINFO_V1_H
#define FZZSES_SEALINFO_V1_H
...
class FZZSES_SealInfo_V1
{
public:
    FZZSES_SealInfo_V1();
    FZZSES_SealInfo_V1(const unsigned char * data,size_t datalen);
    FZZSES_SealInfo_V1(const FZZBytes & data);
    FZZSES_SealInfo_V1(const FZZSES_SealInfo_V1& obj);
	virtual ~FZZSES_SealInfo_V1();
public:
    ...
    FZZSES_ESPropertyInfo_V1* getPropertInfo() {return m_property;}
    void setPropertInfo(FZZSES_ESPropertyInfo_V1 * property)
    {
        if ( m_property != NULL ) {
            delete m_property;
            m_property = NULL;
        }
        m_property = new FZZSES_ESPropertyInfo_V1(*property);
    }
...
private:
    ...
    FZZSES_ESPropertyInfo_V1 * m_property;
    FZZExtensionDatas* m_extDatas;
};

#endif //FZZSES_SEALINFO_V1_H
