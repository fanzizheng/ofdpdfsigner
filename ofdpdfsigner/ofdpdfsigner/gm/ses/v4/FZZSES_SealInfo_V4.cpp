...
/*****************************************************FZZSES_SealInfo_V4******************************************************/
//-----------------------------------------------------------------------------------------------------------------
FZZSES_SealInfo_V4::FZZSES_SealInfo_V4() : m_esID(""),m_picture(NULL),m_header(NULL),m_property(NULL),m_extDatas(NULL)
{
    //DLOG("FZZSES_SealInfo_V4()");
    FZZConst::addClassCount("FZZSES_SealInfo_V4");
}
//-----------------------------------------------------------------------------------------------------------------
FZZSES_SealInfo_V4::FZZSES_SealInfo_V4(const unsigned char * data,size_t datalen):FZZSES_SealInfo_V4()
{
    Deccode(data,datalen);
}
//-----------------------------------------------------------------------------------------------------------------
FZZSES_SealInfo_V4::FZZSES_SealInfo_V4(const FZZBytes & data):FZZSES_SealInfo_V4()
{
    Deccode(data.getData(),data.getLen());
}
//-----------------------------------------------------------------------------------------------------------------
//-----------------------------------------------------------------------------------------------------------------
FZZSES_SealInfo_V4::FZZSES_SealInfo_V4(const FZZSES_SealInfo_V4& obj):FZZSES_SealInfo_V4()
{
    ...
    m_property = obj.m_property == NULL ? NULL : new FZZSES_ESPropertyInfo_V4(*obj.m_property);
    m_extDatas = obj.m_extDatas == NULL ? NULL : new FZZExtensionDatas(*obj.m_extDatas);
    m_esID = obj.m_esID;
}
//-----------------------------------------------------------------------------------------------------------------
FZZSES_SealInfo_V4 ::~FZZSES_SealInfo_V4()
{
    //DLOG("~FZZSES_SealInfo_V4()");
    FZZConst::delClassCount("FZZSES_SealInfo_V4");
...
//-----------------------------------------------------------------------------------------------------------------
FZZBytes FZZSES_SealInfo_V4::Encode()
{
    FZZBytes ret;
    FZZBytes retData;
...
//-----------------------------------------------------------------------------------------------------------------
bool FZZSES_SealInfo_V4::Deccode(const unsigned char * indata,size_t inlenght)
{
    bool isTF = false;
    ...
    m_property = new FZZSES_ESPropertyInfo_V4(data,datalen);
