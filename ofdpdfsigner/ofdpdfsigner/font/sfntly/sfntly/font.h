...
#include "font/sfntly/sfntly/port/endian.h"
#include "font/sfntly/sfntly/data/font_input_stream.h"
#include "font/sfntly/sfntly/data/font_output_stream.h"
#include "font/sfntly/sfntly/data/writable_font_data.h"
...
//  static const int32_t TRUE_TYPE_TABLE_ORDERING[];
  ...
  // @throws IOException
  void SerializeHeader(FontOutputStream* fos, TableHeaderList* table_headers) const;
