...
#include "font/sfntly/sfntly/data/font_input_stream.h"
#include "font/sfntly/sfntly/font_factory.h"
#include "font/sfntly/sfntly/math/fixed1616.h"
#include "font/sfntly/sfntly/math/font_math.h"
#include "font/sfntly/sfntly/port/exception_type.h"
...
void Font::SerializeHeader(FontOutputStream* fos,
                           TableHeaderList* table_headers) const {
...
int32_t Font::Builder::SfntWrapperSize() {
  return (int32_t)(Offset::kSfntHeaderSize +
