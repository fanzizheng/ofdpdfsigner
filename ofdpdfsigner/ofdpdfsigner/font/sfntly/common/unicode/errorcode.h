...
/**
 * \file 
 * \brief C++ API: FZZErrorCode class intended to make it easier to use
 ...
 * The FZZErrorCode base class destructor does nothing.
 *
 ...
 * Sample code:
 * \code
 *   class IcuErrorCode: public icu::FZZErrorCode {
 *   public:
