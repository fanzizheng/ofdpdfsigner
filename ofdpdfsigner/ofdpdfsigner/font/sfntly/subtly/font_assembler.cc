...
#include "font/sfntly/subtly/font_assembler.h"
...
#include "font/sfntly/sfntly/port/refcount.h"
#include "font/sfntly/subtly/font_info.h"
...
bool FontAssembler::AssemblePostScriptTabble() {
  ...
  Ptr<PostScriptTable> post = down_cast<PostScriptTable*>(font_info_->GetTable(0, Tag::post));
    //fzz add begin 2024.08.15
    if ( post.operator sfntly::PostScriptTable *&() == NULL ) {
        return false;
    }
    //fzz add end 2024.08.15
