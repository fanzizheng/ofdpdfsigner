...
/***********************************************FZZFooterXML**************************************************************/
//-----------------------------------------------------------------------------------------------------------------
FZZFooterXML::FZZFooterXML() : FZZOfficeObject(),m_FZZWP(NULL),m_FZZWSdt(NULL)
{
    //DLOG("FZZFooterXML()");
    FZZConst::addClassCount("FZZFooterXML");
    m_doc = new XMLDocument();
    m_doc->InsertEndChild(m_doc->NewDeclaration(XMLHEADER));
    XMLElement* ofd_Document = m_doc->NewElement("w:ftr");
...
//-----------------------------------------------------------------------------------------------------------------
FZZFooterXML::FZZFooterXML(XMLDocument * doc) : FZZOfficeObject(doc),m_FZZWP(NULL),m_FZZWSdt(NULL)
{
    FZZConst::addClassCount("FZZFooterXML");
    //m_FileName = DOCUMENTXMLRELS_FILENAME;
...
//-----------------------------------------------------------------------------------------------------------------
FZZFooterXML::FZZFooterXML(const FZZFooterXML& obj) : FZZOfficeObject(obj)
{
    FZZConst::addClassCount("FZZFooterXML");
    if ( this == &obj ) {
        return;
...
//-----------------------------------------------------------------------------------------------------------------
FZZFooterXML::~FZZFooterXML()
{
    //DLOG("~FZZFooterXML()");
    FZZConst::delClassCount("FZZFooterXML");
    if ( m_FZZWP != NULL ) {
        delete m_FZZWP;
        m_FZZWP = NULL;
    }
